...
<a href="https://github.com/clouddrove/terraform-module-template/actions/workflows/tfsec.yml">
...
| **Provider** | [aws](https://aws.amazon.com/) | >= 5.55.0 |
...
**IMPORTANT:** Since the master branch used in source varies based on new modifications, we recommend using the [release versions](https://github.com/clouddrove/terraform-module-template/releases).
